        ...
        <div className="p-8 space-y-6">
          ...
          <div className="space-y-4">
            <button 
              ...
              disabled={loading}
              className="w-full bg-white text-slate-700 py-4 rounded-2xl font-bold flex items-center justify-center gap-3 border border-slate-200 hover:bg-slate-50 transition-all shadow-md active:scale-95 disabled:opacity-50"
            >
